...
Return ONLY the tweet text(s), one per line, separated by a blank line between tweets. No preamble, no explanation.`;
  ...
  const generate = useCallback(async () => {
    ...
    try {
      ...
      // Split by blank lines to get individual tweets
      const parsed = text
        .split(/\n\s*\n/)
        .map(t => t.trim())
        .filter(t => t.length > 0);
  ...
  return (
    <div style={{
      ...
      <div style={{
        ...
        <div>
          <div style={{ fontFamily: "Space Grotesk, sans-serif", fontWeight: 700, fontSize: "16px" }}>
            Thread Studio
          </div>
            ...
            <div style={{ display: "flex", flexWrap: "wrap", gap: "8px" }}>
              {NICHES.map(n => (
                <button key={n.value} onClick={() => setNiche(n.value)} style={{
                  ...
                  fontSize: "13px", fontFamily: "Space Grotesk, sans-serif", fontWeight: 600,
